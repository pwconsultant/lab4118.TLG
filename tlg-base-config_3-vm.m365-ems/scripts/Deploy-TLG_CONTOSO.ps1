Import-Module Az
$rootPath = "C:\Users\pwood\OneDrive - Kforce, Inc\1-Workarea\lab.contoso\azure"
...
$subscription = "PW_CONTOSO_VSE"
$resourceGroup = $pwLabRGName
...
$domainName = $pwDomainName # The FQDN of the new AD domain.
...
$adminUserName = $pwLabVMAdminUser # The name of the domain administrator account to create, i.e. globaladmin.
$adminPassword = (Get-AzKeyVaultSecret -vaultName $pwLabVaultName -name "vmAdminPassword").SecretValueText  # The administrator account password.
...
$parameters.Add("vmDCSize",$vmDCSize)
$parameters.Add("vmClientSize",$vmClientSize)
$parameters.Add("vmAppSize",$vmAppSize)
